...
```{r}
sce$label <- factor(sce$label, levels = c(1,2,3,4,5))
```
...
```{r}
sce$lvl2[sce$label == 3] <- "CD14+ Mono"
sce$lvl2[sce$label == 1] <- "Int Mono"
sce$lvl2[sce$label == 2] <- "CD16+ Mono"
sce$lvl2[sce$label == 4] <- "DCs"
sce$lvl2[sce$label == 5] <- "Int Mono"
```

```{r}
sce$lvl2 <- factor(sce$lvl2, levels = c("CD14+ Mono","Int Mono","CD16+ Mono","DCs"))
```
