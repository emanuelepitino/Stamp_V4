...
feats_b <- c("CD19","CD79A","CD79B","IGHM","IGKC",
           "BANK1","CD37","CD83","MS4A1","IGHG1","IGHG2","IGHG3","IGHG4","IGHGP",
           "MKI67","STMN1","TCL1A","PRDM1","XBP1","MZB1")

feats_myelo <- c("CD14","CD163","ITGAM","FCGR1A","FCGR3A","CD68","CD86","ITGAX","CD86","CD1C","ARG1")

feats_t <- c("CD3E","CD3D","CD247","CD4","CCR7","SELL","TCF7","IL7R","GATA3","FOXP3","CTLA4",
           "IL2RA","CD8A","CD8B","PRF1","GZMB","GZMA","FCGR3A","NCAM1","NGK7","GZMK","PDCD1","TIGIT")

feats <- c(feats_b,feats_myelo,feats_t)
```
...
sce$lvl2[sce$label == 5] <- "Int Mono"
sce$lvl2[sce$label == 7] <- "Int Mono"
sce$lvl2[sce$label == 8] <- "CD1C+ DCs"
