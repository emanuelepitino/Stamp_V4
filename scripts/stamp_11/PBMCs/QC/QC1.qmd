---
title: "Quality Control - Stamp 11 PBMCs"
...
filt <- sce[,sce$x_centroid > 330 & sce$x_centroid < 8350 & sce$y_centroid > 350 & sce$y_centroid < 8250]
...
gg_mask <- ggplot(df, aes(x = x_centroid, y = y_centroid)) +
  ...
  geom_vline(xintercept = 330, color = "red") +
  geom_vline(xintercept = 8350, color = "red") +
  geom_hline(yintercept = 350, color = "red") +
  geom_hline(yintercept = 8250, color = "red") +
