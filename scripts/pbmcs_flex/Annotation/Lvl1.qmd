...
sce <- qread(glue("{proj_dir}/data/flex_pbmcs/QC/doublets_sce.qs"), nthreads = 8)
```
...
# Save the workbook
dir.create(glue("{proj_dir}/Markers/flex_pbmcs"), showWarnings = F, recursive = T)
saveWorkbook(wb, glue("{proj_dir}/Markers/flex_pbmcs/lvl1.xlsx"), overwrite = TRUE)
```
...
sce$lvl1[sce$label == "3"] <- "Myeloid"
sce$lvl1[sce$label == "4"] <- "Myeloid"
sce$lvl1[sce$label == "5"] <- "CD8"
sce$lvl1[sce$label == "6"] <- "NK"
sce$lvl1[sce$label == "7"] <- "CD4"
sce$lvl1[sce$label == "8"] <- "CD4"
sce$lvl1[sce$label == "9"] <- "Doublets"
sce$lvl1[sce$label == "10"] <- "B"
sce$lvl1[sce$label == "11"] <- "Myeloid"
sce$lvl1[sce$label == "12"] <- "Doublets"
sce$lvl1[sce$label == "13"] <- "Doublets"
sce$lvl1[sce$label == "14"] <- "CD8"
sce$lvl1[sce$label == "15"] <- "CD8"
sce$lvl1[sce$label == "16"] <- "Doublets"
...
```{r}
dir.create(glue("{proj_dir}/data/flex_pbmcs/Lvl1"))
qsave(sce, file = glue("{proj_dir}/data/flex_pbmcs/Lvl1/lvl1_sce.qs"), nthreads = 8)
```
