---
title: "Quality Control - healthy PBMCs 5'"
...
This dataset contains 5' scRNA-seq data from healthy PBMCs. The dataset was downloaded from the 10X genomics website at the following [link](https://www.10xgenomics.com/datasets/10k-human-pbmcs-5-v2-0-chromium-x-with-intronic-reads-2-standard). The FASTQs have also been downsampled to ~20k reads/cell before mapping with cellranger.
...
```{r}
dir.create(glue("{proj_dir}/data/PBMCs_5prime/QC"), showWarnings = F)
qsave(sce, file = glue("{proj_dir}/data/PBMCs_5prime/QC/QC1.qs"), nthreads = 8)
```
