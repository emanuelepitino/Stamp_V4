...
## Run PCA
As we have a big dataset, we run PCA with the fast-approximate Singular value decomposition method from the *rsvd* package.
Refer to chapter **[14.2.2 Singular value decomposition](https://bioconductor.org/books/3.14/OSCA.advanced/dealing-with-big-data.html)** from *OSCA Advanced* for more information.
