...
gg_clust1 <- create_plots2(sce, "label", c("IGKC","IGHM","IGHG1"))
```
...
sce$lvl2[sce$label == "2"] <- "Naive B"
sce$lvl2[sce$label == "4"] <- "Naive B"
sce$lvl2[sce$label == "5"] <- "Naive B"
sce$lvl2[sce$label == "6"] <- "Class-Switched B"
sce$lvl2[sce$label == "3"] <- "pDCs"
```
