...
create_plots2(sce, "label", c("CD4","CD8A","CD8B","GZMK","GZMB","TCF7","GATA3","IL2RA","FOXP3"))
```
...
```{r}
sce$lvl2[sce$label == 1] <- "GZMK+ CD8"
sce$lvl2[sce$label == 10] <- "Naive CD4"
sce$lvl2[sce$label == 11] <- "Naive CD8"
sce$lvl2[sce$label == 2] <- "GZMB+ CD8"
sce$lvl2[sce$label == 3] <- "Th"
sce$lvl2[sce$label == 4] <- "Naive CD8"
sce$lvl2[sce$label == 5] <- "Tregs"
sce$lvl2[sce$label == 6] <- "Naive CD4"
sce$lvl2[sce$label == 7] <- "GZMB+ CD8"
