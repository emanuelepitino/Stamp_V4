---
title: "Level 2 annotation - stamp5"
...
sce$lvl2[sce$label == "2"] <- "CD56dim CD16+ NK"
sce$lvl2[sce$label == "3"] <- "CD56dim CD16+ NK"
sce$lvl2[sce$label == "5"] <- "CD56dim CD16+ NK"
sce$lvl2[sce$label == "4"] <- "NK-T"
sce$lvl2[sce$label == "6"] <- "CD56+ CD16- NK"
```
