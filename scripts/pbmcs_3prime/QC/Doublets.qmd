---
title: "Doublets scoring - PBMCs 3 prime"
...
sce <- qread(glue("{proj_dir}/data/PBMCs_3prime/QC/QC1.qs"), nthreads = 8)
```
...
# Save
```{r}
qsave(sce,file = glue("{proj_dir}/data/PBMCs_3prime/QC/doublets_sce.qs"), nthreads = 8)
```
