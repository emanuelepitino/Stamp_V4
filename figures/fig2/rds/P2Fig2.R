...
pos <- pos & common_theme & theme(legend.position = "top")
...
pan2 <- wrap_plots(A_B,C_D, ncol = 1)

fig2 <- wrap_plots(pos,pan2, ncol = 2) + plot_layout(widths = c(1,2))

dir <- glue("./../raw")
dir.create(dir, showWarnings = F)
pdf(file = glue("{dir}/fig2.pdf"), width = 15, height = 10)
fig2
dev.off()
